...
describe("TextFieldComponent", function() {
  ...
  describe("modelValid", function() {
    ...
    it("return true if the model is dirty but valid", function() {
      var model = {
        dirty: true,
        invalid: false
      }
    ...
    it("returns true if model is invalid but not dirty", function() {
      var model = {
        dirty: false,
        invalid" true
      }
  ...
  describe("validationPattern", function() {
    ...
    it(returns the pattern if it's set", function() {
      ...
      expect(component.validtionPattern()).toBe(pattern);
    });
  });
});
